//
//  CallSetTableViewController.swift
//  FakeCallApp
//
...
class CallSetTableViewController: UITableViewController {
 
    override func viewDidLoad() {
        super.viewDidLoad()
        
        self.tableView.register(UINib(nibName: "CallTimeCell", bundle: nil), forCellReuseIdentifier: "Cell")
